...
export const MOCK_MARKETS: ExploreMarket[] = [
  ...
  },
  {
    ...
    image_url: '/images/explore/events/uefa-champions-league-winner.png',
    category: 'Sports',
    subcategory: 'UCL',
    volume: 203_313_747,
    ...
    outcomes: [
      { id: 'POLY-33506-ars', label: 'Arsenal', probability: 0.20, clob_id: 'POLY-33506-ARS', image_slug: 'arsenal.png', jupiterMarketId: 'POLY-566140' },
      { id: 'POLY-33506-mci', label: 'Manchester City', probability: 0.10, clob_id: 'POLY-33506-MCI', image_slug: 'manchester-city.png', jupiterMarketId: 'POLY-566141' },
      { id: 'POLY-33506-rma', label: 'Real Madrid', probability: 0.07, clob_id: 'POLY-33506-RMA', image_slug: 'real-madrid.png', jupiterMarketId: 'POLY-566139' },
      { id: 'POLY-33506-liv', label: 'Liverpool', probability: 0.09, clob_id: 'POLY-33506-LIV', image_slug: 'liverpool.png', jupiterMarketId: 'POLY-566137' },
      { id: 'POLY-33506-bar', label: 'Barcelona', probability: 0.12, clob_id: 'POLY-33506-BAR', image_slug: 'barcelona.png', jupiterMarketId: 'POLY-566138' },
      { id: 'POLY-33506-bay', label: 'Bayern Munich', probability: 0.18, clob_id: 'POLY-33506-BAY', image_slug: 'bayern-munich.png', jupiterMarketId: 'POLY-566142' },
      { id: 'POLY-33506-psg', label: 'PSG', probability: 0.10, clob_id: 'POLY-33506-PSG', image_slug: 'psg.png', jupiterMarketId: 'POLY-566136' },
    ],
    is_binary: false,
    status: 'active',
  },
  ...
  },
  {
    ...
    outcomes: [
      { id: 'POLY-42365-dec26', label: 'By Dec 31, 2026', probability: 0.12, clob_id: 'POLY-42365-DEC26', jupiterMarketId: 'POLY-1107737' },
      { id: 'POLY-42365-mar26', label: 'By Mar 31, 2026', probability: 0.026, clob_id: 'POLY-42365-MAR26', jupiterMarketId: 'POLY-663544' },
    ],
    is_binary: false,
    status: 'active',
  },
  {
    ...
    outcomes: [
      { id: 'POLY-31759-yes', label: 'Yes', probability: 0.09, clob_id: 'POLY-31759-YES', jupiterMarketId: 'POLY-561829' },
    ],
    is_binary: true,
    status: 'active',
  },
  {
    ...
    outcomes: [
      { id: 'POLY-86832-ubisoft', label: 'Ubisoft', probability: 0.43, clob_id: 'POLY-86832-UBISOFT', image_slug: 'ubisoft.jpeg', jupiterMarketId: 'POLY-694939' },
      { id: 'POLY-86832-perplexity', label: 'Perplexity AI', probability: 0.44, clob_id: 'POLY-86832-PERPLEXITY', jupiterMarketId: 'POLY-700396' },
      { id: 'POLY-86832-lovable', label: 'Lovable', probability: 0.36, clob_id: 'POLY-86832-LOVABLE', jupiterMarketId: 'POLY-700395' },
      { id: 'POLY-86832-gitlab', label: 'GitLab', probability: 0.33, clob_id: 'POLY-86832-GITLAB', jupiterMarketId: 'POLY-694940' },
      { id: 'POLY-86832-nebius', label: 'Nebius Group', probability: 0.26, clob_id: 'POLY-86832-NEBIUS', jupiterMarketId: 'POLY-694936' },
      { id: 'POLY-86832-snap', label: 'Snapchat', probability: 0.19, clob_id: 'POLY-86832-SNAP', image_slug: 'snapchat.jpeg', jupiterMarketId: 'POLY-694932' },
      { id: 'POLY-86832-anthropic', label: 'Anthropic', probability: 0.19, clob_id: 'POLY-86832-ANTHROPIC', jupiterMarketId: 'POLY-700397' },
      { id: 'POLY-86832-zoom', label: 'Zoom', probability: 0.18, clob_id: 'POLY-86832-ZOOM', image_slug: 'zoom.jpeg', jupiterMarketId: 'POLY-694935' },
      { id: 'POLY-86832-viking', label: 'Viking Therapeutics', probability: 0.17, clob_id: 'POLY-86832-VIKING', image_slug: 'viking-therapeutics.jpeg', jupiterMarketId: 'POLY-694938' },
      { id: 'POLY-86832-openai', label: 'OpenAI', probability: 0.12, clob_id: 'POLY-86832-OPENAI', jupiterMarketId: 'POLY-700398' },
    ],
    is_binary: false,
    status: 'active',
  },
